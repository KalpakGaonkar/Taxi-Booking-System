...
<body>
  <div class="row main-row fill">
    ...
    <div class="col-sm-10 col-xs-12 main-content-area">
        <br>
         <form name="updateForm" action="../phpFiles/update.php" method="post" style="margin-left: 20px;">  
        <div class="form-group">
          <label for="text">Driver ID:</label>
          <input type="text" class="form-control" id="driver_id" placeholder="Enter ID" name="driver_id" style="width: 50%;">
        </div>
        <div class="form-group">
          
        <div class="form-group">
          <label for="pwd">Contact No:</label>
          <input type="text" class="form-control" id="contact" placeholder="Enter Contact No." name="contact" style="width: 50%;">
        </div>
