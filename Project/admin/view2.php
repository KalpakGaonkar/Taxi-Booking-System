  ...
  <div class="row main-row fill">
    <div class="col-sm-2 sidebar hidden-xs" style="background-color: #383839">
      ...
      <div class="dropdown-container"><br>
        ...
        <a href="../admin/../admin/delete1.php"><i class="far fa-trash-alt"></i>&nbsp;&nbsp;Delete</a><br>
    ...
    <div class="col-sm-10 col-xs-12 main-content-area">
        <br>
         <form name="viewForm" action="../phpFiles/view_driver.php" method="post" style="margin-left: 20px;">    
        <div class="form-group">
          <label for="text">Driver ID:</label>
          <input type="text" class="form-control" id="driver_id" placeholder="Enter ID or Type 'all' to display all values" name="driver_id" style="width: 50%;">
        </div>
