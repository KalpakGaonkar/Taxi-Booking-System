...
<body>
  <div class="row main-row fill">
    ...
    <div class="col-sm-10 col-xs-12 main-content-area">
        <br>
         <form name="insForm" action="../phpFiles/insert_driver.php" method="post" style="margin-left: 20px;">
        ...
        <div class="form-group">
          ...
          <input  pattern="[0-9A-Z].{6,}" required=""   type="text" class="form-control" id="reg_no" placeholder="Enter Registration Number" name="reg_no" style="width: 50%;">
        </div>
        <div class="form-group">
          <label for="pwd">Type of Vehicle:</label><br>
          <select required="" id="type" name="type" style="width: 540px;border-width: 1px; border-color: lightgrey; border-radius: 5px; border-style: solid; height: 40px;">
        ...
        <button name="ins2" type="submit" class="btn btn-primary" onclick="">Submit</button><br>
