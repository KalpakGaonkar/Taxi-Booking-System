...
<body>
  <div class="row main-row fill">
    ...
    <div class="col-sm-10 col-xs-12 main-content-area">
        <br>
         <form name="insForm" action="../phpFiles/delete_driver.php" method="post" style="margin-left: 20px;">
        ...
        <button name="ins2" type="submit" class="btn btn-primary" onclick="">Delete</button><br>
